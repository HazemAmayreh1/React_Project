        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.inputGroup}>
            <div className={styles.inputBorder}>
              <label htmlFor="userName" className={styles.insideLabel}>
                Name
              </label>
              <input
                type="text"
            ...
            <div className={styles.inputBorder}>
              <label htmlFor="email" className={styles.insideLabel}>
                Email
              </label>
              <input
                type="email"
            ...
            <div className={styles.inputBorder}>
              <label htmlFor="password" className={styles.insideLabel}>
                Password
              </label>
              <input
                type="password"
